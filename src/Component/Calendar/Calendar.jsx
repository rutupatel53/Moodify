...
const meetings = [
  {
    ...
    startDatetime: "2024-02-11T13:00",
    endDatetime: "2024-03-11T14:30",
  },
  {
    id: 2,
    name: "Michael Foster",
  ...
  return (
    <li className="items-center px-4 py-2 space-x-4 group rounded-xl focus-within:bg-gray-100 hover:bg-gray-100">
      ...
      >
        ...
        >
          <Menu.Items className="absolute right-0 z-10 mt-2 origin-bottom-right bg-white rounded-md shadow-lg w-36 ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="py-1">
              <Menu.Item>
                {({ active }) => (
                  <a
